...
import com.klm.flight.repository.AirportDao;
...
public class AirportServiceImpl implements AirportService {
	 ...
	 */
	@Override
	public Airport viewAirport(String origin) {
		Optional<Airport> findByName = airportDao.findByAirportName(origin);
		if (findByName.isPresent()) {
			...
			throw new RecordNotFoundException("Airport with airport name: " + origin + "not exists");
	    }
