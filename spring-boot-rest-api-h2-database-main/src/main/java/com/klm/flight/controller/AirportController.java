...
public class AirportController {
	/*
	 * @Autowired(required = true) AirportService airportService;
	 * 
	 * @GetMapping("/viewAirport/{id}")
	 * 
	 * @ExceptionHandler(RecordNotFoundException.class) public Airport
	 * viewAirport(@PathVariable("id") String airportCode) { return
	 * airportService.viewAirport(airportCode); }
	 * 
	 * @GetMapping("/allAirport") public Iterable<Airport> viewAllAirport() { return
	 * airportService.viewAllAirport(); }
	 * 
